...
const String _computeRouteMatrixUrl =
    '$_routesApiUrl/distanceMatrix/v2:computeRouteMatrix';
const String _mapsApiKey = GOOGLE_MAPS_API_KEY;

/// Queries the Google Maps Routes API and returns a list of route tokens.
///
/// [waypoints] is a list of [NavigationWaypoints] representing the route waypoints.
